...
import { CheckCircle2, XCircle, Loader2, Server, Database, Shield, AlertCircle, RefreshCw } from 'lucide-react';
...
const ConnectionTest = () => {
        ...
        try {
            ...
            setTests(prev => ({
                ...
                login: {
                    ...
                    data: {
                        ...loginRes.data,
                        token_preview: loginRes.data.access_token?.substring(0, 50) + '...',
                    },
                },
            }));
        } catch (error) {
    ...
    const TestCard = ({ title, icon: Icon, test, description }) => {
    ...
    const anyTestFailed = Object.values(tests).some(t => t.status === 'error');
